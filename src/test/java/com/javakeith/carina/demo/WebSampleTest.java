package com.javakeith.carina.demo;
...
import com.javakeith.carina.demo.gui.components.NewsItem;
import com.javakeith.carina.demo.gui.components.compare.ModelSpecs;
import com.javakeith.carina.demo.gui.components.compare.ModelSpecs.SpecType;
import com.javakeith.carina.demo.gui.pages.common.AllBrandsPageBase;
...
import com.javakeith.carina.demo.gui.pages.common.HomePageBase;
import com.javakeith.carina.demo.gui.pages.common.ModelInfoPageBase;
import com.javakeith.carina.demo.gui.pages.common.NewsPageBase;
...
public class WebSampleTest implements IAbstractTest {
    ...
    public void testModelSpecs() {
        ...
        // Select phone model
        ModelInfoPageBase productInfoPage = productsPage.selectModel("Galaxy A35");
        // Verify phone specifications
        SoftAssert softAssert = new SoftAssert();
        softAssert.assertEquals(productInfoPage.readDisplay(), "6.6\"", "Invalid display info!");
    ...
    public void testNewsSearch() {
        ...
        for (NewsItem n : news) {
            ...
            softAssert.assertTrue(isTextContained(n.readTitle(), searchQ, (k,v) -> k.toLowerCase().contains(v.toLowerCase())),
                    "Invalid search results for " + n.readTitle());
        }
        softAssert.assertAll();
    }

    private static boolean isTextContained(String mainText, String containedText, BiFunction<String, String, Boolean> lambda) {
        return lambda.apply(mainText, containedText);
    }
